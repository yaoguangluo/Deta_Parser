...
## 版本号：11.1.0: 随机测试文章来自 360八卦新闻推荐, 腾讯门户, 163门户,总计100多篇文章, 约4万字, 算法问题导致错误分词8个(错误率万分之四),词库缺少导致错误12个(错误率万分之六), <中文分析错误率小于亿分之一> 是一个艰巨的主题. 算法问题的扩充 时时更新在 HUB上.2019-05-24 2:00 AM
