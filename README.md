...
## 版本号：10.6.3 快速混合分词.(契形+中(简,繁)日,韩,象形 带病句快速混分) 未优化语料库版(这个星期作者认真优化成语语料库,成语语料库在修正中.).
![实例](https://github.com/yaoguangluo/Deta_Parser/blob/master/DETA%20201904221.jpg)
## 版本号：10.6.4 快速歧义病句混合分词.(契形+中(简,繁)日,韩,象形 带病句快速混分) 商业语料库版(Deta分词功能需求定义为在无标点,歧义,绕口令病句中快速混合分词的高质量算法研究.).
