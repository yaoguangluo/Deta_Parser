...
## 版本号：11.1.0: 随机测试文章来自 360八卦新闻推荐, 腾讯门户, 163门户,总计80多篇文章, 约5万字, 算法问题导致错误分词3个(错误率万分之一),词库缺少导致错误23个(错误率万分之七), <中文分析错误率小于亿分之一> 是一个艰巨的主题. 算法问题的扩充 时时更新在 HUB上.2019-05-25 2:00 AM
